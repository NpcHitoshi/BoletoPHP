        ...
        <nav class="navbar navbar">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                    <li class="<?php
                    if (isset($boletos_active)) {
                        echo $boletos_active;
                    }
                    ?>"><a href="boletos.php">Boletos</a></li>
                    <li class="<?php
                    if (isset($clientes_active)) {
                ...
                <ul class="nav navbar-nav navbar-right">
                    <div class="navbar-header">
                        <span class="navbar-brand" href=""><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION["usuario"]->getNomeAdministrador() ?></span>
                    </div>
