    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group col-md-4">
          ...
          <input id="num" type="text" name="num" class="form-control" placeholder="Número"/>
        </div>
      ...
      <div id="cadastrar" class="col-md-12">
        <button type="button" class="btn btn-default col-md-offset-5 col-md-2">Cadastrar</button>
      </div>
    </form>
  </div>
</body>
