...
$dias_de_prazo_para_pagamento = 60;
$taxa_boleto = 0;
...
$valor_cobrado = "130,00"; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
$valor_cobrado = str_replace(",", ".",$valor_cobrado);
$valor_boleto=number_format($valor_cobrado+$taxa_boleto, 2, ',', '');

//calcular multa
$multa = $valor_cobrado*0.03;
$multa = str_replace(".", ",",$multa);
$multa.= "0";
//calcular juros
$juros = round($valor_cobrado*0.0015, 2);
$juros = str_replace(".", ",",$juros);
$juros.= "0";

$dadosboleto["inicio_nosso_numero"] = "24";  // 24 - Padrão da Caixa Economica Federal
$dadosboleto["nosso_numero"] = "10472/1";  // Nosso numero sem o DV - REGRA: Máximo de 8 caracteres!
...
$dadosboleto["sacado"] = "CLIENTE TESTE";
...
$dadosboleto["cedente"] = "MICROVIL AUTOMACAO COMERCIAL LTDA";
